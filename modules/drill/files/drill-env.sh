...
export DRILL_JAVA_OPTS="-Xms64M -Xmx$DRILL_HEAP -XX:MaxDirectMemorySize=$DRILL_MAX_DIRECT_MEMORY -XX:MaxPermSize=128M -XX:ReservedCodeCacheSize=64M -Ddrill.exec.enable-epoll=true"
